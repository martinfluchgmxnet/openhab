Introduction LgTV Binding / Martin Fluch 25.1.2014 		martinfluch@gmx.net
...
################################# LgTV  Binding ####################################### Host of the first lgtv device to control # lgtv:<lgtvId1>.host=# Port of the lgtv to control (optional, defaults to 60128)# lgtv:<lgtvId1>.port=# Host of the first lgtv device to control # lgtv:<lgtvId2>.host=# Port of the lgtv to control (optional, defaults to 60128)# lgtv:<lgtvId2>.port=
...
#pairkey - fill in after you have seen on tv
lgtv:wohnzimmer.pairkey=
#local port on the openhab machine for the eventserver
lgtv:wohnzimmer.serverport=9080
#path to the directory where to store the xml files (applist, channellist)
lgtv:wohnzimmer.xmldatafiles=./
#start the keepalivechecking
